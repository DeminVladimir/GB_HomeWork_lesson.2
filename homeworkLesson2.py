...
the_amount = int(input("Введите сумму натуральных чисел \n"))
composition = int(input("Введите произведение натуральных чисел \n"))
discriminant = (the_amount**2) - ((4 * (-1) * (- composition)))
x = (-the_amount + math.isqrt(discriminant)) / 2 * -1
y = (-the_amount - math.isqrt(discriminant)) / 2 * -1
print(int(x), int(y))